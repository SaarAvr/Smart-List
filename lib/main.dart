          ...
          return FutureBuilder(
            ...
            builder: (context, userSnapshot) {
              ...
              if (userSnapshot.hasData && userSnapshot.data != null) {
                return ListsScreen(userId: user.uid);
              } else {
                return CompleteProfileScreen(firebaseUser: user);
              }
            },
          );
        } else {
  ...
  Future<void> _initFirebase() async {
    try {
      ...
      if (Firebase.apps.isNotEmpty) {
        setState(() {
          _firebaseStatus = 'Firebase already initialized!';
        });
      } else {
        await Firebase.initializeApp();
        setState(() {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(_firebaseStatus ?? 'Initializing Firebase...'),
          ],
        ),
      ),
    );
